    ...
    public void serialiseringAvJsonOgBrukAvBuilderGirSammeResultat() throws JSONException {
        ...
        OmsorgspengerSoknad fraBuilder = OmsorgspengerSoknad
                ...
                .barn(Barn.builder()
                        ...
                        .norskIdentitetsnummer(NorskIdentitetsnummer.of((fraJson.barn.norskIdentitetsnummer == null) ? null : fraJson.barn.norskIdentitetsnummer.verdi))
                        .build())
                .soker(Soker.builder()
                        .norskIdentitetsnummer(NorskIdentitetsnummer.of((fraJson.soker.norskIdentitetsnummer == null) ? null : fraJson.soker.norskIdentitetsnummer.verdi))
                        .build())
