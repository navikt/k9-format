package no.nav.k9.oppgave.bekreftelse.ung.aktivitet;
...
public record AktivitetAvklaringBekreftelse(
    ...
    public AktivitetAvklaringBekreftelse(UUID oppgaveReferanse, boolean harUttalelse, String uttalelseFraBruker) {
    ...
    @Override
    public Type getType() {
        return Type.AVP_AKTIVITET_AVKLARING;
    }
    ...
    public Bekreftelse medDataBruktTilUtledning(DataBruktTilUtledning dataBruktTilUtledning) {
        return new AktivitetAvklaringBekreftelse(oppgaveReferanse, harUttalelse, uttalelseFraBruker, dataBruktTilUtledning);
    }
}
