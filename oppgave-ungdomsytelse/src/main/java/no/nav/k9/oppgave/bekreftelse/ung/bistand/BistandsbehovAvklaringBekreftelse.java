package no.nav.k9.oppgave.bekreftelse.ung.bistand;
...
public record BistandsbehovAvklaringBekreftelse(
    ...
    public BistandsbehovAvklaringBekreftelse(UUID oppgaveReferanse, boolean harUttalelse, String uttalelseFraBruker) {
    ...
    @Override
    public Type getType() {
        return Type.AVP_BISTANDSBEHOV_AVKLARING;
    }
    ...
    public Bekreftelse medDataBruktTilUtledning(DataBruktTilUtledning dataBruktTilUtledning) {
        return new BistandsbehovAvklaringBekreftelse(oppgaveReferanse, harUttalelse, uttalelseFraBruker, dataBruktTilUtledning);
    }
}
