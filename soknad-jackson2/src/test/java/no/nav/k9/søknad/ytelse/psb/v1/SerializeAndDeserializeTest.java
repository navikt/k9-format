...
class SerializeAndDeserializeTest {
    ...
    public void komplettSøknadTest() {
        ...
        var serializedSøknad = JsonUtils.toString(søknad);
        var deserilizedSøknad = JsonUtils.fromString(serializedSøknad, Søknad.class);

        verifyIngenFeil(deserilizedSøknad);
        assertEquals(JsonUtils.toString(deserilizedSøknad), serializedSøknad);
    }
}
