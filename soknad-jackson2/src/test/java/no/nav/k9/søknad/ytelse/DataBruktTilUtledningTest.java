...
class DataBruktTilUtledningTest {
    ...
    @BeforeEach
    void setUp() {
        this.dataBruktTilUtledning = new DateBruktTilUtledningJackson2();
    }
    ...
    public void testDeserialisering() throws JSONException {
        ...
        DataBruktTilUtledning deserialisertData = JsonUtils.fromString(jsonString, DateBruktTilUtledningJackson2.class);
        DataBruktTilUtledning forventetDataBruktTilUtledning = new DateBruktTilUtledningJackson2()
                .medHarBekreftetOpplysninger(true)
                .medHarForståttRettigheterOgPlikter(true)
                .medSoknadDialogCommitSha("1234567890")
                .medAnnetData(
