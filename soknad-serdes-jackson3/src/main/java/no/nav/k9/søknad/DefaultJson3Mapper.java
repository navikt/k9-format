...
public class DefaultJson3Mapper {
    ...
    private static RuntimeException deserializationException(JacksonException e) {
        return new IllegalArgumentException("Fikk JacksonException ved deserialisering av JSON", e);
    }

    private static RuntimeException serializationException(JacksonException e) {
        return new IllegalArgumentException("Kunne ikke serialisere objekt til JSON", e);
    }
