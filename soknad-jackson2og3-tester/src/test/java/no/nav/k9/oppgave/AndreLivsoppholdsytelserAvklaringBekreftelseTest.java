...
class AndreLivsoppholdsytelserAvklaringBekreftelseTest {

    @Test
    void validering_feiler_når_harUttalelse_true_men_uttalelse_mangler() {
        String json = """
                {
                  "type": "AVP_ANDRE_LIVSOPPHOLDSYTELSER_AVKLARING",
                  "oppgaveReferanse": "00000000-0000-0000-0000-000000000008",
                  "harUttalelse": true
                }
                """;
    ...
    void roundtrip_serialiserer_riktig_type_og_deserialiserer_til_riktig_record() {
        var original = new AndreLivsoppholdsytelserAvklaringBekreftelse(
        ...
        assertThat(roundtrip.getType()).isEqualTo(Bekreftelse.Type.AVP_ANDRE_LIVSOPPHOLDSYTELSER_AVKLARING);
    }
}
