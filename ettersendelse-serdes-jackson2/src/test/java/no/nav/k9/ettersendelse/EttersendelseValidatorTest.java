...
public class EttersendelseValidatorTest {
    ...
    public void ettersendelseUtenNoeSatt() {
        ...
        Ettersendelse ettersendelse = EttersendelseSerDes.deserialize("{\"versjon\":\"0.0.1\"}");
    ...
    public void komplettEttersendelseFraJson() {
        Ettersendelse ettersendelse = EttersendelseSerDes.deserialize(jsonForKomplettEttersendelse());
